...
static input int    Magic_Number = 1946147062; // Magic number
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 19, 28, 4)
   ...
   // Average True Range (22), Level: 0.0021
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":84,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[7,3,0,0,0],"numValues":[19,28,4,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[22,0.0021,0,0,0,0]}]} */
