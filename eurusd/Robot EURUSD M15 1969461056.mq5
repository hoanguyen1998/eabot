...
static input int    Magic_Number = 1969461056; // Magic number
...
static input string ___1______   = "------"; // --- RSI ---
       input int    Ind1Param0   =       47; // Period
       input int    Ind1Param1   =       98; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":83,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[7,0,0,0,0],"numValues":[12,0,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[5,3,0,0,0],"numValues":[47,98,0,0,0,0]}]} */
