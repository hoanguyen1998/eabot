...
static input int    Magic_Number = 270491652; // Magic number
...
void InitIndicators(void)
  {
   ...
   // Standard Deviation (Close, Simple, 45), Level: 0.0000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":78,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[7,0,0,0,0],"numValues":[31,0,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[4,3,0,0,0],"numValues":[45,0,0,0,0,0]}]} */
