...
static input int    Magic_Number = 1466388075; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =        4; // Fast EMA
       input int    Ind0Param1   =       18; // Slow EMA
...
static input string ___1______   = "------"; // --- Accelerator Oscillator ---
       input double Ind1Param0   =  -0.0054; // Level
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 4, 18, 10)
   ...
   // Accelerator Oscillator, Level: -0.0054
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":93,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[7,3,0,0,0],"numValues":[4,18,10,0,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-0.0054,0,0,0,0,0]}]} */
