...
static input int    Magic_Number = 266225402; // Magic number
...
static input string ___2______   = "------"; // --- Stochastic ---
       ...
       input int    Ind2Param2   =        5; // Slowing
       input double Ind2Param3   =      0.0; // Level
...
void ManageClose(void)
  {
   ...
   bool   ind2long  = ind2val1 < Ind2Param3 - sigma && ind2val2 > Ind2Param3 + sigma;
   bool   ind2short = ind2val1 > 100 - Ind2Param3 + sigma && ind2val2 < 100 - Ind2Param3 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":81,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[18,32,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[13,1,5,0,0,0]}]} */
