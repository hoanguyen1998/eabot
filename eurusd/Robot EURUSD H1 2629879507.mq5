...
static input int    Magic_Number = 1314939754; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       58; // Stop Loss   (pips)
...
static input string ___3______   = "------"; // --- Average True Range ---
       input int    Ind3Param0   =       23; // Period
       input double Ind3Param1   =   0.0019; // Level
...
void InitIndicators(void)
  {
   ...
   // Average True Range (23), Level: 0.0019
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":58,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[1,0,0,0,0],"numValues":[30,0,0,0,0,0]},{"name":"Bears Power","listIndexes":[3,0,0,0,0],"numValues":[11,0,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[1,0,0,0,0],"numValues":[45,-20,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[23,0.0019,0,0,0,0]}]} */
