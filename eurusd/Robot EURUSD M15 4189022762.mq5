...
static input int    Magic_Number = 2094511381; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       56; // Stop Loss   (pips)
       input int    Take_Profit  =       73; // Take Profit (pips)
...
void InitIndicators(void)
  {
   ...
   // Moving Average of Oscillator (Close, 12, 17, 12)
   ...
   // Envelopes (Close, Simple, 11, 1.00)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":56,"takeProfit":73,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Momentum","listIndexes":[7,3,0,0,0],"numValues":[31,100,0,0,0,0]},{"name":"Moving Average of Oscillator","listIndexes":[1,3,0,0,0],"numValues":[12,17,12,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[11,1,0,0,0,0]}]} */
