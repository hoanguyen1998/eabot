...
static input int    Magic_Number = 1716373995; // Magic number
...
void InitIndicators(void)
  {
   ...
   // Average True Range (18), Level: 0.0050
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":84,"takeProfit":88,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[6,0,0,0,0],"numValues":[1,-20,0,0,0,0]},{"name":"Stochastic","listIndexes":[1,0,0,0,0],"numValues":[15,9,10,50,0,0]},{"name":"Average True Range","listIndexes":[1,0,0,0,0],"numValues":[27,0.0011,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[18,0.005,0,0,0,0]}]} */
