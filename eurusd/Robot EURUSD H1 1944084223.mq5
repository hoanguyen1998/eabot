...
void InitIndicators(void)
  {
   ...
   // RSI (Close, 46), Level: 19
   indHandlers[0][1][0] = iRSI(NULL, 0, Ind1Param0, PRICE_CLOSE);
...
void ManageClose(void)
  {
   ...
   bool   ind1short = ind1val1 > 100 - Ind1Param1 + sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":89,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"MACD Signal","listIndexes":[1,3,0,0,0],"numValues":[21,25,7,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[46,19,0,0,0,0]}]} */
