...
static input int    Magic_Number = 1169633412; // Magic number
...
static input string ___2______   = "------"; // --- Bulls Power ---
       ...
       input double Ind2Param1   =   0.0123; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":80,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"DeMarker","listIndexes":[7,0,0,0,0],"numValues":[18,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[2,0,0,0,0],"numValues":[19,0.0123,0,0,0,0]}]} */
