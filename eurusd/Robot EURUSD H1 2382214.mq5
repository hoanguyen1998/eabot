...
static input int    Magic_Number = 2382214; // Magic number
...
static input string ___1______   = "------"; // --- Candle Color ---
       input int    Ind1Param0   =       48; // Min body height [pips]
       input int    Ind1Param1   =        1; // Consecutive candles
...
int GetEntrySignal(void)
  {
   ...
   bool   ind0short = ind0val1 > 200 - Ind0Param1 + sigma && ind0val2 < 200 - Ind0Param1 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":90,"takeProfit":97,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Momentum","listIndexes":[5,3,0,0,0],"numValues":[12,100,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[48,1,0,0,0,0]}]} */
