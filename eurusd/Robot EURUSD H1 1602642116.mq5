...
static input int    Magic_Number = 1602642116; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       82; // Stop Loss   (pips)
       input int    Take_Profit  =       92; // Take Profit (pips)
...
static input string ___1______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind1Param0   =       22; // Fast MA period
       input int    Ind1Param1   =       44; // Slow MA period

static input string ___2______   = "------"; // --- Stochastic ---
       input int    Ind2Param0   =       13; // %K Period
       input int    Ind2Param1   =        7; // %D Period
       input int    Ind2Param2   =        9; // Slowing
       input double Ind2Param3   =     27.0; // Level

static input string ___3______   = "------"; // --- DeMarker ---
       input int    Ind3Param0   =       49; // Period
       input double Ind3Param1   =     0.19; // Level
...
void InitIndicators(void)
  {
   ...
   // Moving Averages Crossover (Simple, Simple, 22, 44)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":82,"takeProfit":92,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Momentum","listIndexes":[7,3,0,0,0],"numValues":[40,100,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[2,0,0,0,0],"numValues":[22,44,0,0,0,0]},{"name":"Stochastic","listIndexes":[3,0,0,0,0],"numValues":[13,7,9,27,0,0]}],"closeFilters":[{"name":"DeMarker","listIndexes":[5,0,0,0,0],"numValues":[49,0.19,0,0,0,0]}]} */
