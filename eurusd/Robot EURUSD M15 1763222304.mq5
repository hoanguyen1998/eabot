...
static input int    Magic_Number = 1763222304; // Magic number
...
static input string ___1______   = "------"; // --- MACD Signal ---
       input int    Ind1Param0   =        6; // Fast EMA
       input int    Ind1Param1   =       26; // Slow EMA
       input int    Ind1Param2   =        9; // MACD SMA

static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       32; // Min body height [pips]
       input int    Ind2Param1   =        4; // Consecutive candles
...
void InitIndicators(void)
  {
   // DeMarker (34)
   indHandlers[0][0][0] = iDeMarker(NULL, 0, Ind0Param0);
   if(Show_inds) ChartIndicatorAdd(0, 1, indHandlers[0][0][0]);
   // MACD Signal (Close, 6, 26, 9)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":56,"takeProfit":89,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"DeMarker","listIndexes":[7,0,0,0,0],"numValues":[34,0,0,0,0,0]},{"name":"MACD Signal","listIndexes":[3,3,0,0,0],"numValues":[6,26,9,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[32,4,0,0,0,0]}]} */
