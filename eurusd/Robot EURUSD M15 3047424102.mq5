...
static input int    Magic_Number = 1523712051; // Magic number
...
static input string ___2______   = "------"; // --- Bulls Power ---
       ...
       input double Ind2Param1   =  -0.0149; // Level
...
void InitIndicators(void)
  {
   // Standard Deviation (Close, Simple, 38)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":80,"takeProfit":88,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Standard Deviation","listIndexes":[6,3,0,0,0],"numValues":[38,0,0,0,0,0]},{"name":"Bulls Power","listIndexes":[0,0,0,0,0],"numValues":[28,0,0,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[25,-0.0149,0,0,0,0]}]} */
