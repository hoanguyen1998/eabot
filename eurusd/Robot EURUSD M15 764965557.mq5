...
static input int    Magic_Number = 764965557; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       85; // Stop Loss   (pips)
       input int    Take_Profit  =       89; // Take Profit (pips)

static input string ___0______   = "------"; // --- RSI ---
       input int    Ind0Param0   =       47; // Period
       input int    Ind0Param1   =       50; // Level

static input string ___1______   = "------"; // --- Stochastic ---
       input int    Ind1Param0   =        2; // %K Period
       input int    Ind1Param1   =        1; // %D Period
       input int    Ind1Param2   =        1; // Slowing
       input double Ind1Param3   =     45.0; // Level

static input string ___2______   = "------"; // --- RSI ---
       input int    Ind2Param0   =       31; // Period
       input int    Ind2Param1   =       68; // Level
...
void InitIndicators(void)
  {
   // RSI (Close, 47)
   indHandlers[0][0][0] = iRSI(NULL, 0, Ind0Param0, PRICE_CLOSE);
   if(Show_inds) ChartIndicatorAdd(0, 1, indHandlers[0][0][0]);
   // Stochastic (2, 1, 1), Level: 45.0
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":85,"takeProfit":89,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[7,3,0,0,0],"numValues":[47,50,0,0,0,0]},{"name":"Stochastic","listIndexes":[3,0,0,0,0],"numValues":[2,1,1,45,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[5,3,0,0,0],"numValues":[31,68,0,0,0,0]}]} */
