...
static input int    Magic_Number = 1181029245; // Magic number
...
void InitIndicators(void)
  {
   ...
   // Moving Average of Oscillator (Close, 7, 29, 8), Level: 0.0000
   ...
   // Average True Range (47), Level: 0.0041
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":97,"takeProfit":98,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[13,9,2,0,0,0]},{"name":"Moving Average of Oscillator","listIndexes":[2,3,0,0,0],"numValues":[7,29,8,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[2,0,0,0,0],"numValues":[47,0.0041,0,0,0,0]}]} */
