...
static input int    Magic_Number = 1380532277; // Magic number
...
static input string ___0______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind0Param0   =       15; // Fast MA period
       input int    Ind0Param1   =       48; // Slow MA period

static input string ___1______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind1Param0   =        7; // Fast EMA
       input int    Ind1Param1   =       11; // Slow EMA
       input int    Ind1Param2   =        6; // MACD SMA
       input double Ind1Param3   =   0.0000; // Level

static input string ___2______   = "------"; // --- Average True Range ---
       input int    Ind2Param0   =       11; // Period
       input double Ind2Param1   =   0.0051; // Level

static input string ___3______   = "------"; // --- Envelopes ---
       input int    Ind3Param0   =        3; // Period
       input double Ind3Param1   =     0.47; // Deviation %
...
void InitIndicators(void)
  {
   // Moving Averages Crossover (Simple, Simple, 15, 48)
   ...
   // Moving Average of Oscillator (Close, 7, 11, 6), Level: 0.0000
   ...
   // Average True Range (11), Level: 0.0051
   indHandlers[0][2][0] = iATR(NULL, 0, Ind2Param0);
   if(Show_inds) ChartIndicatorAdd(0, 2, indHandlers[0][2][0]);
   // Envelopes (Close, Simple, 3, 0.47)
...
int GetEntrySignal(void)
  {
   ...
   bool   ind1short = ind1val1 < -Ind1Param3 - sigma;
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET BlackBull; EURUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":75,"takeProfit":90,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[15,48,0,0,0,0]},{"name":"Moving Average of Oscillator","listIndexes":[2,3,0,0,0],"numValues":[7,11,6,0,0,0]},{"name":"Average True Range","listIndexes":[3,0,0,0,0],"numValues":[11,0.0051,0,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[0,3,0,0,0],"numValues":[3,0.47,0,0,0,0]}]} */
