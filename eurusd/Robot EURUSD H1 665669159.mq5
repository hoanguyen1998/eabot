...
static input int    Magic_Number = 665669159; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       72; // Stop Loss   (pips)
       input int    Take_Profit  =       72; // Take Profit (pips)
...
static input string ___2______   = "------"; // --- Bollinger Bands ---
       ...
       input double Ind2Param1   =     3.00; // Deviation
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":72,"takeProfit":72,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[6,3,0,0,0],"numValues":[48,50,0,0,0,0]},{"name":"DeMarker","listIndexes":[1,0,0,0,0],"numValues":[1,0,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[5,3,0,0,0],"numValues":[18,3,0,0,0,0]}]} */
