...
static input int    Magic_Number = 1139277901; // Magic number
...
static input string ___2______   = "------"; // --- Envelopes ---
       input int    Ind2Param0   =       40; // Period
       input double Ind2Param1   =     0.71; // Deviation %
...
void InitIndicators(void)
  {
   ...
   // Envelopes (Close, Simple, 40, 0.71)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":73,"takeProfit":92,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[7,3,0,0,0],"numValues":[18,50,0,0,0,0]},{"name":"Stochastic","listIndexes":[1,0,0,0,0],"numValues":[14,5,12,50,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[40,0.71,0,0,0,0]}]} */
