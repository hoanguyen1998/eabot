...
static input int    Magic_Number = 1172470476; // Magic number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":90,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[17,12,8,0,0,0]},{"name":"Stochastic","listIndexes":[1,0,0,0,0],"numValues":[13,5,11,50,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[31,94,0,0,0,0]}]} */
