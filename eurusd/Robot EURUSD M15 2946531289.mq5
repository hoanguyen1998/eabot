...
static input int    Magic_Number = 1473265645; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       55; // Stop Loss   (pips)
       input int    Take_Profit  =       83; // Take Profit (pips)
...
static input string ___2______   = "------"; // --- DeMarker ---
       input int    Ind2Param0   =        4; // Period
       input double Ind2Param1   =     0.00; // Level

static input string ___3______   = "------"; // --- Stochastic Signal ---
       input int    Ind3Param0   =        2; // %K Period
       input int    Ind3Param1   =        1; // %D Period
       input int    Ind3Param2   =        1; // Slowing
...
void InitIndicators(void)
  {
   // Moving Average (Simple, Close, 15, 0)
   ...
   indHandlers[0][3][0] = iStochastic(NULL, 0, Ind3Param0, Ind3Param1, Ind3Param2, MODE_SMA, STO_LOWHIGH);
...
void ManageClose(void)
  {
   // Stochastic Signal (2, 1, 1)
   double ind3buffer0[]; CopyBuffer(indHandlers[0][3][0], MAIN_LINE,   1, 2, ind3buffer0);
   double ind3buffer1[]; CopyBuffer(indHandlers[0][3][0], SIGNAL_LINE, 1, 2, ind3buffer1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":55,"takeProfit":83,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[6,0,3,0,0],"numValues":[15,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"DeMarker","listIndexes":[1,0,0,0,0],"numValues":[4,0,0,0,0,0]}],"closeFilters":[{"name":"Stochastic Signal","listIndexes":[3,0,0,0,0],"numValues":[2,1,1,0,0,0]}]} */
