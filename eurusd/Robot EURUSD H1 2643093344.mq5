...
static input int    Magic_Number = 1321546672; // Magic number
...
static input string ___1______   = "------"; // --- Alligator ---
       ...
       input int    Ind1Param1   =       22; // Jaws shift
       input int    Ind1Param2   =       22; // Teeth period
...
static input string ___3______   = "------"; // --- Bears Power ---
       input int    Ind3Param0   =       39; // Period
       input double Ind3Param1   =   0.0129; // Level
...
void InitIndicators(void)
  {
   ...
   // Alligator (Smoothed, Median, 37, 22, 22, 6, 6, 5)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":72,"takeProfit":97,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Awesome Oscillator","listIndexes":[7,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Alligator","listIndexes":[1,3,4,0,0],"numValues":[37,22,22,6,6,5]},{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[2,0,0,0,0],"numValues":[39,0.0129,0,0,0,0]}]} */
