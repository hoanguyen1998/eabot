...
static input int    Magic_Number = 166969351; // Magic number
...
static input string ___0______   = "------"; // --- Williams' Percent Range ---
       input int    Ind0Param0   =       22; // Period
       input double Ind0Param1   =    -63.0; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":72,"takeProfit":77,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":true},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[22,-63,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[3,3,0,0,0],"numValues":[33,0,0,0,0,0]}]} */
