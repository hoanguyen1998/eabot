...
static input int    Magic_Number = 196710705; // Magic number
...
static input string ___1______   = "------"; // --- Bulls Power ---
       input int    Ind1Param0   =        4; // Period
       input double Ind1Param1   =  -0.0156; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":73,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[6,0,0,0,0],"numValues":[29,-20,0,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[4,-0.0156,0,0,0,0]}]} */
