...
static input int    Magic_Number = 298429496; // Magic number
...
static input string ___1______   = "------"; // --- Stochastic Signal ---
       input int    Ind1Param0   =        6; // %K Period
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":84,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Standard Deviation","listIndexes":[7,3,0,0,0],"numValues":[16,0,0,0,0,0]},{"name":"Stochastic Signal","listIndexes":[3,0,0,0,0],"numValues":[6,3,5,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[5,3,0,0,0],"numValues":[31,3,0,0,0,0]}]} */
