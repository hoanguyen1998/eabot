...
static input int    Magic_Number = 2133312645; // Magic number
...
static input string ___1______   = "------"; // --- Candle Color ---
       input int    Ind1Param0   =       44; // Min body height [pips]
       input int    Ind1Param1   =        2; // Consecutive candles
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":88,"takeProfit":97,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[1,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[44,2,0,0,0,0]}]} */
