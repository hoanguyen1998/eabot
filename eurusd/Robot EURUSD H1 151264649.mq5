...
static input int    Magic_Number = 151264649; // Magic number
...
static input string ___2______   = "------"; // --- Envelopes ---
       ...
       input double Ind2Param1   =     0.23; // Deviation %
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":79,"takeProfit":85,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[1,0,0,0,0],"numValues":[15,0,0,0,0,0]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[3,2,2,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[0,3,0,0,0],"numValues":[6,0.23,0,0,0,0]}]} */
