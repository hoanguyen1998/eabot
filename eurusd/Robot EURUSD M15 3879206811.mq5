...
static input int    Magic_Number = 1939603406; // Magic number
...
static input string ___2______   = "------"; // --- Bears Power ---
       ...
       input double Ind2Param1   =   0.0090; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":88,"takeProfit":92,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[5,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[10,2,7,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[2,0,0,0,0],"numValues":[6,0.009,0,0,0,0]}]} */
