...
static input int    Magic_Number = 1548942159; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       62; // Stop Loss   (pips)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":62,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[7,0,0,0,0],"numValues":[29,-20,0,0,0,0]},{"name":"DeMarker","listIndexes":[1,0,0,0,0],"numValues":[15,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[18,4,0,0,0,0]}]} */
