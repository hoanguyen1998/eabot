...
static input int    Magic_Number = 249629514; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       52; // Stop Loss   (pips)
       input int    Take_Profit  =       78; // Take Profit (pips)

static input string ___0______   = "------"; // --- Stochastic ---
       input int    Ind0Param0   =        4; // %K Period
       input int    Ind0Param1   =        1; // %D Period
       input int    Ind0Param2   =        3; // Slowing
       input double Ind0Param3   =      9.0; // Level

static input string ___1______   = "------"; // --- Alligator ---
       input int    Ind1Param0   =       39; // Jaws period
...
void InitIndicators(void)
  {
   ...
   // Alligator (Smoothed, Median, 39, 22, 22, 6, 6, 5)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":52,"takeProfit":78,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[4,0,0,0,0],"numValues":[4,1,3,9,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[10,3,4,0,0],"numValues":[39,22,22,6,6,5]}]} */
