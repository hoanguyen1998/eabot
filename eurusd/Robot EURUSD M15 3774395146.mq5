...
static input int    Magic_Number = 1887197573; // Magic number
...
static input string ___1______   = "------"; // --- Stochastic ---
       ...
       input int    Ind1Param2   =        4; // Slowing
       input double Ind1Param3   =      3.0; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":90,"takeProfit":91,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[7,3,0,0,0],"numValues":[6,50,0,0,0,0]}],"closeFilters":[{"name":"Stochastic","listIndexes":[4,0,0,0,0],"numValues":[5,3,4,3,0,0]}]} */
