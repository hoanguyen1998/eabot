...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 16, 49, 8)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":80,"takeProfit":91,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[7,3,0,0,0],"numValues":[16,49,8,0,0,0]},{"name":"Stochastic","listIndexes":[3,0,0,0,0],"numValues":[12,3,8,27,0,0]}],"closeFilters":[{"name":"Stochastic Signal","listIndexes":[0,0,0,0,0],"numValues":[9,1,2,0,0,0]}]} */
