...
static input int    Magic_Number = 1509470174; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       24; // Fast EMA
...
static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =        6; // Min body height [pips]
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 24, 47, 12)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":71,"takeProfit":89,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[7,3,0,0,0],"numValues":[24,47,12,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[6,3,0,0,0,0]}]} */
