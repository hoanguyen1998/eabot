...
static input int    Magic_Number = 669984785; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       91; // Stop Loss   (pips)
       input int    Take_Profit  =       98; // Take Profit (pips)

static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       23; // Fast EMA
       input int    Ind0Param1   =       39; // Slow EMA
...
static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       15; // Min body height [pips]
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 23, 39, 9)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":91,"takeProfit":98,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[6,3,0,0,0],"numValues":[23,39,9,0,0,0]},{"name":"ADX","listIndexes":[1,0,0,0,0],"numValues":[45,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[15,4,0,0,0,0]}]} */
