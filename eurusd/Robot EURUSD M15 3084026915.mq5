...
static input int    Magic_Number = 1542013458; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       93; // Stop Loss   (pips)
...
void InitIndicators(void)
  {
   // Williams' Percent Range (37), Level: -53.0
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":93,"takeProfit":98,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[37,-53,0,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[1,5,0,0,0],"numValues":[27,100,0,0,0,0]}],"closeFilters":[{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[4,1,1,0,0,0]}]} */
