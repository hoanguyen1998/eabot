...
static input int    Magic_Number = 2136693725; // Magic number
...
static input string ___1______   = "------"; // --- Average True Range ---
       ...
       input double Ind1Param1   =   0.0004; // Level

static input string ___2______   = "------"; // --- Awesome Oscillator ---
       input double Ind2Param0   =  -0.0134; // Level
...
void InitIndicators(void)
  {
   ...
   // Awesome Oscillator, Level: -0.0134
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":90,"takeProfit":94,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[6,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Average True Range","listIndexes":[1,0,0,0,0],"numValues":[2,0.0004,0,0,0,0]}],"closeFilters":[{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-0.0134,0,0,0,0,0]}]} */
