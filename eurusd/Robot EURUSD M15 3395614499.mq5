...
static input int    Magic_Number = 1697807250; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       77; // Stop Loss   (pips)
       input int    Take_Profit  =       77; // Take Profit (pips)

static input string ___0______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind0Param0   =       17; // Fast MA period
       input int    Ind0Param1   =       43; // Slow MA period

static input string ___1______   = "------"; // --- Stochastic Signal ---
       input int    Ind1Param0   =        9; // %K Period
       input int    Ind1Param1   =        5; // %D Period
       input int    Ind1Param2   =        6; // Slowing

static input string ___2______   = "------"; // --- Momentum ---
       input int    Ind2Param0   =       25; // Period
       input double Ind2Param1   =  97.0000; // Level
...
void InitIndicators(void)
  {
   // Moving Averages Crossover (Simple, Simple, 17, 43)
   ...
   // Momentum (Close, 25), Level: 97.0000
   indHandlers[0][2][0] = iMomentum(NULL, 0, Ind2Param0, PRICE_CLOSE);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":77,"takeProfit":77,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[17,43,0,0,0,0]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[9,5,6,0,0,0]}],"closeFilters":[{"name":"Momentum","listIndexes":[4,3,0,0,0],"numValues":[25,97,0,0,0,0]}]} */
