...
static input int    Magic_Number = 1347303543; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average ---
       input int    Ind0Param0   =        3; // Period
       input int    Ind0Param1   =        0; // Shift

static input string ___1______   = "------"; // --- Accelerator Oscillator ---
       input double Ind1Param0   =   0.0000; // Level

static input string ___2______   = "------"; // --- Stochastic Signal ---
       input int    Ind2Param0   =        5; // %K Period
       input int    Ind2Param1   =        2; // %D Period
...
static input string ___4______   = "------"; // --- Standard Deviation ---
       ...
       input double Ind4Param1   =   0.0000; // Level
...
void InitIndicators(void)
  {
   // Moving Average (Simple, Close, 3, 0)
   ...
   // Stochastic Signal (5, 2, 4)
   indHandlers[0][2][0] = iStochastic(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, MODE_SMA, STO_LOWHIGH);
   if(Show_inds) ChartIndicatorAdd(0, 2, indHandlers[0][2][0]);
   // Envelopes (Close, Simple, 14, 0.51)
   ...
   // Standard Deviation (Close, Simple, 37), Level: 0.0000
...
int GetEntrySignal(void)
  {
   ...
   // Stochastic Signal (5, 2, 4)
   double ind2buffer0[]; CopyBuffer(indHandlers[0][2][0], MAIN_LINE,   1, 2, ind2buffer0);
   double ind2buffer1[]; CopyBuffer(indHandlers[0][2][0], SIGNAL_LINE, 1, 2, ind2buffer1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":75,"takeProfit":90,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[6,0,3,0,0],"numValues":[3,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[5,2,4,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[14,0.51,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[5,3,0,0,0],"numValues":[37,0,0,0,0,0]}]} */
