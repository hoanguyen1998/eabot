...
static input int    Magic_Number = 1898985711; // Magic number
...
static input string ___1______   = "------"; // --- Bollinger Bands ---
       ...
       input double Ind1Param1   =     3.83; // Deviation
...
void InitIndicators(void)
  {
   ...
   // Bollinger Bands (Close, 18, 3.83)
   indHandlers[0][1][0] = iBands(NULL, 0, Ind1Param0, 0, Ind1Param1, PRICE_CLOSE);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":94,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Commodity Channel Index","listIndexes":[7,5,0,0,0],"numValues":[7,100,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[3,3,0,0,0],"numValues":[18,3.83,0,0,0,0]}]} */
