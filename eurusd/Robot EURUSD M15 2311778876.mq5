...
static input string ___2______   = "------"; // --- DeMarker ---
       input int    Ind2Param0   =       13; // Period
       input double Ind2Param1   =     0.95; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":98,"takeProfit":98,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":true},"openFilters":[{"name":"MACD Signal","listIndexes":[1,3,0,0,0],"numValues":[23,36,9,0,0,0]},{"name":"Bears Power","listIndexes":[0,0,0,0,0],"numValues":[5,0,0,0,0,0]}],"closeFilters":[{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[13,0.95,0,0,0,0]}]} */
