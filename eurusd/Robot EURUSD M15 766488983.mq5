...
static input int    Magic_Number = 766488983; // Magic number
...
static input string ___3______   = "------"; // --- Candle Color ---
       input int    Ind3Param0   =       16; // Min body height [pips]
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":95,"takeProfit":95,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[6,0,3,0,0],"numValues":[17,0,0,0,0,0]},{"name":"DeMarker","listIndexes":[0,0,0,0,0],"numValues":[28,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[2,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[16,3,0,0,0,0]}]} */
