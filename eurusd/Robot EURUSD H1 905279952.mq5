...
static input string ___2______   = "------"; // --- Average True Range ---
       ...
       input double Ind2Param1   =   0.0007; // Level
...
void InitIndicators(void)
  {
   ...
   // Moving Average of Oscillator (Close, 25, 39, 3)
   ...
   // Average True Range (25), Level: 0.0007
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":81,"takeProfit":94,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[17,13,14,0,0,0]},{"name":"Moving Average of Oscillator","listIndexes":[0,3,0,0,0],"numValues":[25,39,3,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[25,0.0007,0,0,0,0]}]} */
