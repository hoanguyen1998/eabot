...
static input int    Magic_Number = 941284925; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       10; // Fast EMA
       input int    Ind0Param1   =       33; // Slow EMA
...
static input string ___1______   = "------"; // --- ADX ---
       ...
       input double Ind1Param1   =     35.0; // Level
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 10, 33, 8)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":75,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[6,3,0,0,0],"numValues":[10,33,8,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[18,35,0,0,0,0]}]} */
