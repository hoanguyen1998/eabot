...
static input int    Magic_Number = 1285370060; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       79; // Stop Loss   (pips)
       input int    Take_Profit  =       87; // Take Profit (pips)

static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       19; // Fast EMA
       input int    Ind0Param1   =       29; // Slow EMA
       input int    Ind0Param2   =       10; // MACD SMA
       input double Ind0Param3   =   0.0000; // Level

static input string ___1______   = "------"; // --- ADX ---
       input int    Ind1Param0   =        9; // Period
       input double Ind1Param1   =     36.0; // Level

static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       42; // Min body height [pips]
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 19, 29, 10)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":79,"takeProfit":87,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[6,3,0,0,0],"numValues":[19,29,10,0,0,0]},{"name":"ADX","listIndexes":[3,0,0,0,0],"numValues":[9,36,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[42,2,0,0,0,0]}]} */
