...
static input int    Magic_Number = 1193715454; // Magic number
...
static input string ___0______   = "------"; // --- Standard Deviation ---
       input int    Ind0Param0   =       16; // Period
       input double Ind0Param1   =   0.0000; // Level

static input string ___1______   = "------"; // --- MACD ---
       input int    Ind1Param0   =        4; // Fast EMA
       input int    Ind1Param1   =       20; // Slow EMA
...
static input string ___2______   = "------"; // --- Moving Averages Crossover ---
       ...
       input int    Ind2Param1   =       33; // Slow MA period

static input string ___3______   = "------"; // --- Average True Range ---
       input int    Ind3Param0   =       31; // Period
       input double Ind3Param1   =   0.0016; // Level
...
void InitIndicators(void)
  {
   // Standard Deviation (Close, Simple, 16)
   indHandlers[0][0][0] = iStdDev(NULL, 0, Ind0Param0, 0, MODE_SMA, PRICE_CLOSE);
   if(Show_inds) ChartIndicatorAdd(0, 1, indHandlers[0][0][0]);
   // MACD (Close, 4, 20, 9)
   indHandlers[0][1][0] = iMACD(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, PRICE_CLOSE);
   if(Show_inds) ChartIndicatorAdd(0, 2, indHandlers[0][1][0]);
   // Moving Averages Crossover (Simple, Simple, 16, 33)
   ...
   // Average True Range (31), Level: 0.0016
   indHandlers[0][3][0] = iATR(NULL, 0, Ind3Param0);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":81,"takeProfit":86,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Standard Deviation","listIndexes":[7,3,0,0,0],"numValues":[16,0,0,0,0,0]},{"name":"MACD","listIndexes":[3,3,0,0,0],"numValues":[4,20,9,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[2,0,0,0,0],"numValues":[16,33,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[2,0,0,0,0],"numValues":[31,0.0016,0,0,0,0]}]} */
