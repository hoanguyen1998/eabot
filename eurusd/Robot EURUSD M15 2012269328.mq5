...
static input int    Magic_Number = 2012269328; // Magic number
...
int GetEntrySignal(void)
  {
   ...
   bool   ind0short = ind0val1 > 1 - Ind0Param1 + sigma && ind0val2 < 1 - Ind0Param1 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":88,"takeProfit":93,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"DeMarker","listIndexes":[5,0,0,0,0],"numValues":[19,0.43,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[5,0,0,0,0],"numValues":[32,0.007,0,0,0,0]}]} */
