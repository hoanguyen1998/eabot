...
static input int    Magic_Number = 1880558249; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =       93; // Stop Loss   (pips)
       input int    Take_Profit  =       93; // Take Profit (pips)
...
void InitIndicators(void)
  {
   ...
   // Accelerator Oscillator, Level: -0.0050
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":93,"takeProfit":93,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bears Power","listIndexes":[7,0,0,0,0],"numValues":[3,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[39,5,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[5,0,0,0,0],"numValues":[-0.005,0,0,0,0,0]}]} */
