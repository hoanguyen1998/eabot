...
input int Slot5IndParam0 = 350; // Stop Loss
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 21.4.2024 г. from Forex Strategy Builder Professional, v4.3.2";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 52;
   strategy.MinBarsRequired        = 55;
