...
input int Slot3IndParam0 = 28; // Slow MA period
...
input int Slot4IndParam0 = 25; // Slow MA period
input int Slot4IndParam1 = 14; // Fast MA period
input int Slot4IndParam2 = 9; // Signal line period
static input string IndicatorName5 = "Stop Limit"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 400; // Stop Loss
input int Slot5IndParam1 = 700; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 16134940; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 16.9.2023 г. from Forex Strategy Builder Professional, v4.2";
