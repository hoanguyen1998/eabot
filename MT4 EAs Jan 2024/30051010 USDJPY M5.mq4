...
input int Slot2IndParam0 = 3; // Slow MA period
input int Slot2IndParam1 = 31; // Fast MA period
...
static input int Expert_Magic = 6081555; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 8/6/2023 from Forex Strategy Builder Professional, v4.2";
