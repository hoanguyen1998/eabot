...
static input int    Magic_Number = 2005341201; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     2566; // Stop Loss   (pips)
       input int    Take_Profit  =     3516; // Take Profit (pips)

static input string ___0______   = "------"; // --- RSI ---
       input int    Ind0Param0   =       25; // Period
       input int    Ind0Param1   =       71; // Level

static input string ___1______   = "------"; // --- Alligator ---
       input int    Ind1Param0   =       22; // Jaws period
       input int    Ind1Param1   =       10; // Jaws shift
       input int    Ind1Param2   =       10; // Teeth period
       input int    Ind1Param3   =        4; // Teeth shift
       input int    Ind1Param4   =        4; // Lips period
       input int    Ind1Param5   =        1; // Lips shift

static input string ___2______   = "------"; // --- MACD ---
       input int    Ind2Param0   =       20; // Fast EMA
       input int    Ind2Param1   =       45; // Slow EMA
...
int GetEntrySignal(void)
  {
   ...
   // Alligator (Smoothed, Median, 22, 10, 10, 4, 4, 1)
   ...
   double ind1val2  = iAlligator(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, Ind1Param3, Ind1Param4, Ind1Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORTEETH, 2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":2566,"takeProfit":3516,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[4,3,0,0,0],"numValues":[25,71,0,0,0,0]},{"name":"Alligator","listIndexes":[2,3,4,0,0],"numValues":[22,10,10,4,4,1]}],"closeFilters":[{"name":"MACD","listIndexes":[4,3,0,0,0],"numValues":[20,45,9,0,0,0]}]} */
