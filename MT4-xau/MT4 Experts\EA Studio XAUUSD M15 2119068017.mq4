...
static input int    Magic_Number = 2119068017; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     1560; // Stop Loss   (pips)
       input int    Take_Profit  =     8704; // Take Profit (pips)
...
static input string ___1______   = "------"; // --- Williams' Percent Range ---
       ...
       input double Ind1Param1   =    -16.0; // Level

static input string ___2______   = "------"; // --- Bears Power ---
       input int    Ind2Param0   =       24; // Period
       input double Ind2Param1   = -14.7000; // Level
...
int GetEntrySignal(void)
  {
   ...
   // Williams' Percent Range (18), Level: -16.0
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":1560,"takeProfit":8704,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[18,-16,0,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[3,0,0,0,0],"numValues":[24,-14.7,0,0,0,0]}]} */
