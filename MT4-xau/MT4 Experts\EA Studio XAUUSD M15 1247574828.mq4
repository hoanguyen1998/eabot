...
static input int    Magic_Number = 1247574828; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     1307; // Stop Loss   (pips)
       input int    Take_Profit  =     4009; // Take Profit (pips)

static input string ___0______   = "------"; // --- Williams' Percent Range ---
       input int    Ind0Param0   =       18; // Period
       input double Ind0Param1   =    -32.0; // Level

static input string ___1______   = "------"; // --- ADX ---
       input int    Ind1Param0   =       45; // Period
       input double Ind1Param1   =     28.0; // Level

static input string ___2______   = "------"; // --- Average True Range ---
       input int    Ind2Param0   =        3; // Period
       input double Ind2Param1   =  19.4000; // Level
...
int GetEntrySignal(void)
  {
   // Williams' Percent Range (18), Level: -32.0
...
void ManageClose(void)
  {
   // Average True Range (3), Level: 19.4000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":1307,"takeProfit":4009,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":true},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[18,-32,0,0,0,0]},{"name":"ADX","listIndexes":[2,0,0,0,0],"numValues":[45,28,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[5,0,0,0,0],"numValues":[3,19.4,0,0,0,0]}]} */
