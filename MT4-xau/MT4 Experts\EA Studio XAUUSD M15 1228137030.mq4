...
static input int    Magic_Number = 1228137030; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     1114; // Stop Loss   (pips)
       input int    Take_Profit  =     2821; // Take Profit (pips)
...
void ManageClose(void)
  {
   // Average True Range (6), Level: 9.0000
   double ind3val1  = iATR(NULL, 0, Ind3Param0, 1);
   double ind3val2  = iATR(NULL, 0, Ind3Param0, 2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":1114,"takeProfit":2821,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[6,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[0,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[32,0.76,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[5,0,0,0,0],"numValues":[6,9,0,0,0,0]}]} */
