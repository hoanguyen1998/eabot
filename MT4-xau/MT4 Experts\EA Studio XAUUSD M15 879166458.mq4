...
static input int    Magic_Number = 879166458; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     4755; // Stop Loss   (pips)
       input int    Take_Profit  =     7360; // Take Profit (pips)
...
static input string ___1______   = "------"; // --- Moving Averages Crossover ---
       ...
       input int    Ind1Param1   =       40; // Slow MA period
...
int GetEntrySignal(void)
  {
   ...
   // Moving Averages Crossover (Simple, Simple, 24, 40)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":4755,"takeProfit":7360,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[24,40,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[36,5,0,0,0,0]}]} */
