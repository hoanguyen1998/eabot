...
static input int    Magic_Number = 1555613686; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     1701; // Stop Loss   (pips)
       input int    Take_Profit  =     7129; // Take Profit (pips)
...
static input string ___1______   = "------"; // --- DeMarker ---
       ...
       input double Ind1Param1   =     0.90; // Level

static input string ___2______   = "------"; // --- Alligator ---
       input int    Ind2Param0   =       27; // Jaws period
       input int    Ind2Param1   =       13; // Jaws shift
       input int    Ind2Param2   =       13; // Teeth period
       input int    Ind2Param3   =        4; // Teeth shift
...
void ManageClose(void)
  {
   // Alligator (Smoothed, Median, 27, 13, 13, 4, 4, 1)
   double ind2val1  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   1);
   double ind2val2  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":1701,"takeProfit":7129,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"DeMarker","listIndexes":[4,0,0,0,0],"numValues":[20,0.9,0,0,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[5,3,4,0,0],"numValues":[27,13,13,4,4,1]}]} */
