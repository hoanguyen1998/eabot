...
static input int    Magic_Number = 1828630625; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     2438; // Stop Loss   (pips)
       input int    Take_Profit  =     9006; // Take Profit (pips)
...
static input string ___2______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind2Param0   =       20; // Fast MA period
       input int    Ind2Param1   =       47; // Slow MA period

static input string ___3______   = "------"; // --- Alligator ---
       input int    Ind3Param0   =       23; // Jaws period
       input int    Ind3Param1   =       19; // Jaws shift
       input int    Ind3Param2   =       19; // Teeth period
       input int    Ind3Param3   =        8; // Teeth shift
       input int    Ind3Param4   =        8; // Lips period
       input int    Ind3Param5   =        5; // Lips shift

static input string ___4______   = "------"; // --- ADX ---
       input int    Ind4Param0   =       36; // Period
       input double Ind4Param1   =     39.0; // Level
...
int GetEntrySignal(void)
  {
   ...
   // Commodity Channel Index (Typical, 8), Level: 0
   ...
   // Moving Averages Crossover (Simple, Simple, 20, 47)
   ...
   // Alligator (Smoothed, Median, 23, 19, 19, 8, 8, 5)
   double ind3val1  = iAlligator(NULL, 0, Ind3Param0, Ind3Param1, Ind3Param2, Ind3Param3, Ind3Param4, Ind3Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   1);
   double ind3val2  = iAlligator(NULL, 0, Ind3Param0, Ind3Param1, Ind3Param2, Ind3Param3, Ind3Param4, Ind3Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   2);
...
void ManageClose(void)
  {
   // ADX (36), Level: 39.0
   double ind4val1  = iADX(NULL, 0, Ind4Param0, PRICE_CLOSE, 0, 1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":2438,"takeProfit":9006,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[4,5,0,0,0],"numValues":[8,0,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[20,47,0,0,0,0]},{"name":"Alligator","listIndexes":[4,3,4,0,0],"numValues":[23,19,19,8,8,5]}],"closeFilters":[{"name":"ADX","listIndexes":[2,0,0,0,0],"numValues":[36,39,0,0,0,0]}]} */
