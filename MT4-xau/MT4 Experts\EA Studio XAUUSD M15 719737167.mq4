...
static input int    Magic_Number = 719737167; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     3204; // Stop Loss   (pips)
       input int    Take_Profit  =     4196; // Take Profit (pips)

static input string ___0______   = "------"; // --- MACD ---
       input int    Ind0Param0   =        9; // Fast EMA
       input int    Ind0Param1   =       17; // Slow EMA
       input int    Ind0Param2   =        9; // MACD SMA

static input string ___1______   = "------"; // --- MACD Signal ---
       input int    Ind1Param0   =       18; // Fast EMA
       input int    Ind1Param1   =       41; // Slow EMA
       input int    Ind1Param2   =        6; // MACD SMA

static input string ___2______   = "------"; // --- RSI ---
       input int    Ind2Param0   =        9; // Period
       input int    Ind2Param1   =        3; // Level
...
int GetEntrySignal(void)
  {
   ...
   // MACD Signal (Close, 18, 41, 6)
   double ind1val1  = iMACD(NULL, 0,  Ind1Param0,  Ind1Param1,  Ind1Param2, PRICE_CLOSE, MODE_MAIN, 1) - iMACD(NULL, 0,  Ind1Param0,  Ind1Param1,  Ind1Param2, PRICE_CLOSE ,MODE_SIGNAL, 1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":3204,"takeProfit":4196,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":true},"openFilters":[{"name":"MACD","listIndexes":[5,3,0,0,0],"numValues":[9,17,9,0,0,0]},{"name":"MACD Signal","listIndexes":[3,3,0,0,0],"numValues":[18,41,6,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[9,3,0,0,0,0]}]} */
