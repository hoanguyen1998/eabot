...
static input int    Magic_Number = 1154542418; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =     4510; // Stop Loss   (pips)
       input int    Take_Profit  =     8979; // Take Profit (pips)
...
static input string ___2______   = "------"; // --- Alligator ---
       input int    Ind2Param0   =       16; // Jaws period
       input int    Ind2Param1   =       14; // Jaws shift
       input int    Ind2Param2   =       14; // Teeth period
       input int    Ind2Param3   =        2; // Teeth shift
       input int    Ind2Param4   =        2; // Lips period
       input int    Ind2Param5   =        1; // Lips shift

static input string ___3______   = "------"; // --- Bulls Power ---
       input int    Ind3Param0   =        4; // Period
       input double Ind3Param1   =   0.0000; // Level

static input string ___4______   = "------"; // --- DeMarker ---
       input int    Ind4Param0   =       23; // Period
       input double Ind4Param1   =     0.12; // Level
...
int GetEntrySignal(void)
  {
   ...
   // Alligator (Smoothed, Median, 16, 14, 14, 2, 2, 1)
   ...
   // Bulls Power (4)
   double ind3val1  = iBullsPower(NULL, 0, Ind3Param0, PRICE_CLOSE, 1);
   double ind3val2  = iBullsPower(NULL, 0, Ind3Param0, PRICE_CLOSE, 2);
...
void ManageClose(void)
  {
   // DeMarker (23), Level: 0.12
   double ind4val1  = iDeMarker(NULL, 0, Ind4Param0, 1);
   double ind4val2  = iDeMarker(NULL, 0, Ind4Param0, 2);
   bool   ind4long  = ind4val1 < Ind4Param1 - sigma && ind4val2 > Ind4Param1 + sigma;
   bool   ind4short = ind4val1 > 1 - Ind4Param1 + sigma && ind4val2 < 1 - Ind4Param1 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":4510,"takeProfit":8979,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Bears Power","listIndexes":[5,0,0,0,0],"numValues":[21,0,0,0,0,0]},{"name":"Alligator","listIndexes":[7,3,4,0,0],"numValues":[16,14,14,2,2,1]},{"name":"Bulls Power","listIndexes":[1,0,0,0,0],"numValues":[4,0,0,0,0,0]}],"closeFilters":[{"name":"DeMarker","listIndexes":[5,0,0,0,0],"numValues":[23,0.12,0,0,0,0]}]} */
