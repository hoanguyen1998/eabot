...
input int Stop_Loss   = 400; // Stop Loss [point]
input int Take_Profit = 800; // Take Profit [point]
...
input int Slot1IndParam0 = 2; // Slow MA period
...
input int Slot2IndParam0 = 32; // Slow MA period
...
input int Slot3IndParam0 = 100; // Slow MA period
input int Slot3IndParam1 = 40; // Fast MA period
input int Slot3IndParam2 = 10; // Signal line period
static input string IndicatorName4 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 35; // Fast MA period
input int Slot4IndParam1 = 60; // Slow MA period
input int Slot4IndParam2 = 0; // Fast MA shift
input int Slot4IndParam3 = 0; // Slow MA shift
static input string IndicatorName5 = "Envelopes"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 120; // MA period
input double Slot5IndParam1 = 0.4; // Deviation %
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30151004";
   ...
   strategy.Description            = "Exported on 4/15/2022 from Forex Strategy Builder Professional, v3.8.10";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 122;
   strategy.MinBarsRequired        = 125;
   ...
   strategy.Slot[0].IndicatorName    = "Bar Closing";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Bar Closing", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter the market at the end of the bar";
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[1].Text    = "Close";
   ...
   strategy.Slot[1].IndicatorPointer.ListParam[0].Text    = "MACD line rises";
   ...
   strategy.Slot[2].IndicatorPeriod  = DataPeriod_H1;
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "MACD line changes its direction upward";
   ...
   strategy.Slot[4].IndicatorName    = "Moving Averages Crossover";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Moving Averages Crossover", SlotTypes_OpenFilter);

   strategy.Slot[4].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[4].IndicatorPointer.ListParam[0].Index   = 3;
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Fast MA is lower than Slow MA";
   strategy.Slot[4].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[1].Caption = "Base price";
   strategy.Slot[4].IndicatorPointer.ListParam[1].Index   = 3;
   strategy.Slot[4].IndicatorPointer.ListParam[1].Text    = "Close";
   strategy.Slot[4].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[3].Caption = "Fast MA method";
   strategy.Slot[4].IndicatorPointer.ListParam[3].Index   = 0;
   strategy.Slot[4].IndicatorPointer.ListParam[3].Text    = "Simple";
   strategy.Slot[4].IndicatorPointer.ListParam[4].Enabled = true;
   strategy.Slot[4].IndicatorPointer.ListParam[4].Caption = "Slow MA method";
   strategy.Slot[4].IndicatorPointer.ListParam[4].Index   = 0;
   strategy.Slot[4].IndicatorPointer.ListParam[4].Text    = "Simple";

   strategy.Slot[4].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[0].Caption = "Fast MA period";
   strategy.Slot[4].IndicatorPointer.NumParam[0].Value   = Slot4IndParam0;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[1].Caption = "Slow MA period";
   strategy.Slot[4].IndicatorPointer.NumParam[1].Value   = Slot4IndParam1;
   strategy.Slot[4].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[2].Caption = "Fast MA shift";
   strategy.Slot[4].IndicatorPointer.NumParam[2].Value   = Slot4IndParam2;
   strategy.Slot[4].IndicatorPointer.NumParam[3].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[3].Caption = "Slow MA shift";
   ...
   strategy.Slot[5].IndicatorName    = "Envelopes";
   ...
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Envelopes", SlotTypes_Close);

   strategy.Slot[5].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[5].IndicatorPointer.ListParam[0].Index   = 1;
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit long at Lower Band";
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[2].Caption = "Base price";
   strategy.Slot[5].IndicatorPointer.ListParam[2].Index   = 0;
   strategy.Slot[5].IndicatorPointer.ListParam[2].Text    = "Open";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "MA period";
   strategy.Slot[5].IndicatorPointer.NumParam[0].Value   = Slot5IndParam0;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Caption = "Deviation %";
   ...
   strategy.Slot[5].IndicatorPointer.CheckParam[0].Checked = false;
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.10</programVersion><strategyName>30151004</strategyName><profileName>Default profile</profileName><dataSourceName>FSB Demo data</dataSourceName><instrumentSymbol>USDJPY</instrumentSymbol><instrumentPeriod>15</instrumentPeriod><sameDirSignalAction>Add</sameDirSignalAction><oppDirSignalAction>Reverse</oppDirSignalAction><maxOpenLots>0.1</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.1</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 4/15/2022 from Forex Strategy Builder Professional, v3.8.10</description><recommendedBars>1000</recommendedBars><openFilters>4</openFilters><closeFilters>0</closeFilters><firstBar>122</firstBar><minBarsRequired>125</minBarsRequired><permanentStopLoss usePermanentSL=\"True\" permanentSLType=\"Relative\">400</permanentStopLoss><permanentTakeProfit usePermanentTP=\"True\" permanentTPType=\"Relative\">800</permanentTakeProfit><breakEven useBreakEven=\"False\">450</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Bar Closing</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter the market at the end of the bar</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Close</value></listParam></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>MACD line rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>2</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>10</index><value>MACD line is higher than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>32</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>H1</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>6</index><value>MACD line changes its direction upward</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>100</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>40</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>10</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Moving Averages Crossover</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>3</index><value>Fast MA is lower than Slow MA</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Fast MA method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"4\"><caption>Slow MA method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Fast MA period</caption><value>35</value></numParam><numParam paramNumber=\"1\"><caption>Slow MA period</caption><value>60</value></numParam><numParam paramNumber=\"2\"><caption>Fast MA shift</caption><value>0</value></numParam><numParam paramNumber=\"3\"><caption>Slow MA shift</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"5\" slotType=\"Close\"><indicatorName>Envelopes</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>1</index><value>Exit long at Lower Band</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>0</index><value>Open</value></listParam><numParam paramNumber=\"0\"><caption>MA period</caption><value>120</value></numParam><numParam paramNumber=\"1\"><caption>Deviation %</caption><value>0.40</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot></strategy> */
//+------------------------------------------------------------------+
