...
input int Stop_Loss   = 100; // Stop Loss [point]
...
input int Slot0IndParam0 = 160; // MA period
input double Slot0IndParam1 = 1.3; // Multiplier
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 20; // Slow MA period
...
input int Slot2IndParam0 = 10; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 9; // Signal line period
static input string IndicatorName3 = "Account Percent Stop"; // ------ Indicator parameters ------
input double Slot3IndParam0 = 13; // Account percent
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30051010";
   ...
   strategy.FirstBar               = 163;
   strategy.MinBarsRequired        = 166;
   ...
   strategy.Slot[3].IndicatorName    = "Account Percent Stop";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Account Percent Stop", SlotTypes_Close);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Limit the risk to percent of the account";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Account percent";
