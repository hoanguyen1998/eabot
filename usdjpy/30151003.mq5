...
input int Take_Profit = 750; // Take Profit [point]
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30151003";
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "CMO rises";
   ...
   strategy.Slot[4].IndicatorName    = "Money Flow";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Money Flow", SlotTypes_OpenFilter);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Money Flow changes its direction downward";
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit long at Down Fractal";
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[1].Text    = "Visible";
