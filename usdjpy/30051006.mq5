...
input int Stop_Loss   = 150; // Stop Loss [point]
input int Take_Profit = 900; // Take Profit [point]
input int Break_Even  = 0; // Break Even [point]
static input double Martingale_Multiplier=0; // Martingale Multiplier

static input string IndicatorName0 = "Fractal"; // ------ Indicator parameters ------
input int Slot0IndParam0 = -170; // Vertical shift
...
static input string IndicatorName3 = "Stochastics"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 160; // %K period
input int Slot3IndParam1 = 150; // Fast %D period
input int Slot3IndParam2 = 35; // Slow %D period
input int Slot3IndParam3 = 20; // Level
static input string IndicatorName4 = "Fractal"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 200; // Vertical shift
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30051006";
   ...
   strategy.FirstBar               = 348;
   strategy.MinBarsRequired        = 351;
   ...
   strategy.Slot[0].IndicatorName    = "Fractal";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Fractal", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long at Up Fractal";
   strategy.Slot[0].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[0].IndicatorPointer.ListParam[1].Caption = "Visibility";
   strategy.Slot[0].IndicatorPointer.ListParam[1].Index   = 0;
   strategy.Slot[0].IndicatorPointer.ListParam[1].Text    = "Visible";

   strategy.Slot[0].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[0].IndicatorPointer.NumParam[0].Caption = "Vertical shift";
   ...
   strategy.Slot[3].IndicatorName    = "Stochastics";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Stochastics", SlotTypes_OpenFilter);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Slow %D rises";
   ...
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "%K period";
   strategy.Slot[3].IndicatorPointer.NumParam[0].Value   = Slot3IndParam0;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Caption = "Fast %D period";
   strategy.Slot[3].IndicatorPointer.NumParam[1].Value   = Slot3IndParam1;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[2].Caption = "Slow %D period";
   strategy.Slot[3].IndicatorPointer.NumParam[2].Value   = Slot3IndParam2;
   strategy.Slot[3].IndicatorPointer.NumParam[3].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[3].Caption = "Level";
   strategy.Slot[3].IndicatorPointer.NumParam[3].Value   = Slot3IndParam3;
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[1].Text    = "Visible";
