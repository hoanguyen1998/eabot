...
input int Slot1IndParam0 = 14; // Slow MA period
...
static input string IndicatorName3 = "Momentum MA Oscillator"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 140; // Momentum period
input int Slot3IndParam1 = 150; // Signal line period
static input string IndicatorName4 = "Bar Range"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 150; // Number of bars
input int Slot4IndParam1 = 0; // Level
static input string IndicatorName5 = "Trailing Stop Limit"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 1690; // Initial Stop Loss
input int Slot5IndParam1 = 3600; // Take Profit
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30051007";
   ...
   strategy.FirstBar               = 152;
   strategy.MinBarsRequired        = 153;
   ...
   strategy.Slot[3].IndicatorName    = "Momentum MA Oscillator";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Momentum MA Oscillator", SlotTypes_OpenFilter);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Oscillator crosses the zero line downward";
   ...
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Momentum period";
   ...
   strategy.Slot[4].IndicatorName    = "Bar Range";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Bar Range", SlotTypes_OpenFilter);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Bar Range rises";

   strategy.Slot[4].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[4].IndicatorPointer.NumParam[0].Caption = "Number of bars";
   ...
   strategy.Slot[5].IndicatorName    = "Trailing Stop Limit";
   ...
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Trailing Stop Limit", SlotTypes_Close);
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit at Trailing Stop Loss or at a constant Take Profit level";
   strategy.Slot[5].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Caption = "Trailing mode";
   strategy.Slot[5].IndicatorPointer.ListParam[1].Index   = 1;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Text    = "New tick (trader)";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "Initial Stop Loss";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.8</programVersion><strategyName>30051007</strategyName><profileName>Default profile</profileName><dataSourceName>JFD MetaTrader 4</dataSourceName><instrumentSymbol>USDJPY</instrumentSymbol><instrumentPeriod>5</instrumentPeriod><sameDirSignalAction>Add</sameDirSignalAction><oppDirSignalAction>Reverse</oppDirSignalAction><maxOpenLots>0.1</maxOpenLots><useAccountPercentEntry>False</useAccountPercentEntry><entryLots>0.1</entryLots><addingLots>0.1</addingLots><reducingLots>0.1</reducingLots><useMartingale>False</useMartingale><martingaleMultiplier>2</martingaleMultiplier><description>Exported on 21/06/2021 from Forex Strategy Builder Professional, v3.8.8</description><recommendedBars>1000</recommendedBars><openFilters>4</openFilters><closeFilters>0</closeFilters><firstBar>152</firstBar><minBarsRequired>153</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">500</permanentStopLoss><permanentTakeProfit usePermanentTP=\"False\" permanentTPType=\"Relative\">500</permanentTakeProfit><breakEven useBreakEven=\"False\">1000</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Bar Closing</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter the market at the end of the bar</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Close</value></listParam></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>11</index><value>MACD line is lower than the Signal line</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>14</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>H1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>MACD</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>3</index><value>MACD line is lower than zero</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><listParam paramNumber=\"3\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>Slow MA period</caption><value>32</value></numParam><numParam paramNumber=\"1\"><caption>Fast MA period</caption><value>12</value></numParam><numParam paramNumber=\"2\"><caption>Signal line period</caption><value>9</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M30</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Momentum MA Oscillator</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>5</index><value>Oscillator crosses the zero line downward</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Signal line method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"3\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Momentum period</caption><value>140</value></numParam><numParam paramNumber=\"1\"><caption>Signal line period</caption><value>150</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Bar Range</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Bar Range rises</value></listParam><numParam paramNumber=\"0\"><caption>Number of bars</caption><value>150</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"5\" slotType=\"Close\"><indicatorName>Trailing Stop Limit</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit at Trailing Stop Loss or at a constant Take Profit level</value></listParam><listParam paramNumber=\"1\"><caption>Trailing mode</caption><index>1</index><value>New tick (trader)</value></listParam><numParam paramNumber=\"0\"><caption>Initial Stop Loss</caption><value>1690</value></numParam><numParam paramNumber=\"1\"><caption>Take Profit</caption><value>3600</value></numParam></slot></strategy> */
//+------------------------------------------------------------------+
