...
input int Stop_Loss   = 1000; // Stop Loss [point]
input int Take_Profit = 1000; // Take Profit [point]
...
input int Slot2IndParam0 = 24; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 9; // Signal line period
static input string IndicatorName3 = "Rate of Change"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 90; // Period
input int Slot3IndParam1 = 70; // Smoothing period
input double Slot3IndParam2 = 1; // Level
static input string IndicatorName4 = "Fractal"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 700; // Vertical shift
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30151001";
   ...
   strategy.FirstBar               = 162;
   strategy.MinBarsRequired        = 165;
   ...
   strategy.Slot[3].IndicatorName    = "Rate of Change";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Rate of Change", SlotTypes_OpenFilter);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "ROC rises";
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Exit long at Up Fractal";
