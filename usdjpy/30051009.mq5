...
static input string IndicatorName0 = "Donchian Channel"; // ------ Indicator parameters ------
input int Slot0IndParam0 = 60; // Period
input int Slot0IndParam1 = 130; // Shift
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 38; // Slow MA period
...
input int Slot2IndParam0 = 22; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 9; // Signal line period
static input string IndicatorName3 = "Take Profit"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 900; // Take Profit
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30051009";
   ...
   strategy.FirstBar               = 193;
   strategy.MinBarsRequired        = 194;
   ...
   strategy.Slot[0].IndicatorName    = "Donchian Channel";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Donchian Channel", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[1].Text    = "High & Low";
   ...
   strategy.Slot[3].IndicatorName    = "Take Profit";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Take Profit", SlotTypes_Close);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Exit at Take Profit level";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Take Profit";
