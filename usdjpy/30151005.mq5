...
input int Break_Even  = 400; // Break Even [point]
...
input int Slot1IndParam0 = 22; // Slow MA period
...
input int Slot2IndParam0 = 38; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 16; // Signal line period
static input string IndicatorName3 = "ROC MA Oscillator"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 20; // ROC period
input int Slot3IndParam1 = 25; // Signal line period
static input string IndicatorName4 = "Moving Average"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 4; // Period
input int Slot4IndParam1 = 0; // Shift
static input string IndicatorName5 = "Fractal"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 450; // Vertical shift
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "30151005";
   ...
   strategy.Description            = "Exported on 21/06/2021 from Forex Strategy Builder Professional, v3.8.8";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 27;
   strategy.MinBarsRequired        = 41;
   ...
   strategy.Slot[3].IndicatorName    = "ROC MA Oscillator";
   ...
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("ROC MA Oscillator", SlotTypes_OpenFilter);

   strategy.Slot[3].IndicatorPointer.ListParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Caption = "Logic";
   strategy.Slot[3].IndicatorPointer.ListParam[0].Index   = 5;
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "ROC MA Oscillator crosses the zero line downward";
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[2].Caption = "Signal line method";
   strategy.Slot[3].IndicatorPointer.ListParam[2].Index   = 0;
   strategy.Slot[3].IndicatorPointer.ListParam[2].Text    = "Simple";
   strategy.Slot[3].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[3].Caption = "Base price";
   strategy.Slot[3].IndicatorPointer.ListParam[3].Index   = 3;
   strategy.Slot[3].IndicatorPointer.ListParam[3].Text    = "Close";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "ROC period";
   strategy.Slot[3].IndicatorPointer.NumParam[0].Value   = Slot3IndParam0;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[1].Caption = "Signal line period";
   ...
   strategy.Slot[4].IndicatorName    = "Moving Average";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("Moving Average", SlotTypes_OpenFilter);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "Moving Average rises";
   ...
   strategy.Slot[4].IndicatorPointer.NumParam[1].Caption = "Shift";
   ...
   strategy.Slot[5].IndicatorName    = "Fractal";
   ...
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Fractal", SlotTypes_Close);
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[0].Text    = "Exit long at Up Fractal";
   strategy.Slot[5].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Caption = "Visibility";
   strategy.Slot[5].IndicatorPointer.ListParam[1].Index   = 1;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Text    = "Visible or shadowed";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "Vertical shift";
