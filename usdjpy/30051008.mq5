...
input int Slot0IndParam2 = 29; // Kijun
input int Slot0IndParam4 = 72; // Senkou Span B
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 8; // Slow MA period
...
input int Slot2IndParam0 = 8; // Slow MA period
input int Slot2IndParam1 = 10; // Fast MA period
...
input int Slot3IndParam0 = 80; // Period of %R
input int Slot3IndParam1 = 110; // Smoothing period
input int Slot3IndParam2 = -20; // Level
static input string IndicatorName4 = "Stop Limit"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 800; // Stop Loss
input int Slot4IndParam1 = 700; // Take Profit
