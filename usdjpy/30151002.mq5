...
input int Take_Profit = 850; // Take Profit [point]
input int Break_Even  = 0; // Break Even [point]
static input double Martingale_Multiplier=0; // Martingale Multiplier

static input string IndicatorName0 = "Price Move"; // ------ Indicator parameters ------
input int Slot0IndParam0 = 75; // Price move
static input string IndicatorName1 = "MACD"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 16; // Slow MA period
...
input int Slot2IndParam0 = 34; // Slow MA period
input int Slot2IndParam1 = 12; // Fast MA period
input int Slot2IndParam2 = 9; // Signal line period
static input string IndicatorName3 = "Previous High Low"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 700; // Vertical shift
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   Strategy *strategy = new Strategy(2, 0);

   strategy.StrategyName           = "30151002";
   ...
   strategy.Slot[0].IndicatorName    = "Price Move";
   ...
   strategy.Slot[0].IndicatorPointer = indicatorManager.CreateIndicator("Price Move", SlotTypes_Open);
   ...
   strategy.Slot[0].IndicatorPointer.ListParam[0].Text    = "Enter long after an upward move";
   ...
   strategy.Slot[0].IndicatorPointer.NumParam[0].Caption = "Price move";
   ...
   strategy.Slot[0].IndicatorPointer.CheckParam[0].Checked = false;
   ...
   strategy.Slot[3].IndicatorName    = "Previous High Low";
   strategy.Slot[3].SlotType         = SlotTypes_Close;
   ...
   strategy.Slot[3].LogicalGroup     = "";
   strategy.Slot[3].IndicatorPointer = indicatorManager.CreateIndicator("Previous High Low", SlotTypes_Close);
   ...
   strategy.Slot[3].IndicatorPointer.ListParam[0].Text    = "Exit long at the previous low";
   strategy.Slot[3].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[3].IndicatorPointer.ListParam[1].Caption = "Base price";
   strategy.Slot[3].IndicatorPointer.ListParam[1].Index   = 0;
   strategy.Slot[3].IndicatorPointer.ListParam[1].Text    = "High & Low";

   strategy.Slot[3].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[3].IndicatorPointer.NumParam[0].Caption = "Vertical shift";
