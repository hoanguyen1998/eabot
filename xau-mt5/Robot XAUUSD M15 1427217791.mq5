...
static input int    Magic_Number = 1427217791; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =     3599; // Stop Loss   (pips)
       input int    Take_Profit  =     4972; // Take Profit (pips)

static input string ___0______   = "------"; // --- Momentum ---
       input int    Ind0Param0   =       33; // Period
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":3599,"takeProfit":4972,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Momentum","listIndexes":[6,3,0,0,0],"numValues":[33,100,0,0,0,0]}],"closeFilters":[{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[2,1,1,0,0,0]}]} */
