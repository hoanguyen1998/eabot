...
static input int    Magic_Number = 2092357928; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =     3126; // Stop Loss   (pips)
       input int    Take_Profit  =     3300; // Take Profit (pips)
...
void InitIndicators(void)
  {
   ...
   // Envelopes (Close, Simple, 30, 0.71)
   ...
   // Average True Range (38), Level: 11.9000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":3126,"takeProfit":3300,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[8,4,4,0,0,0]},{"name":"Envelopes","listIndexes":[0,3,0,0,0],"numValues":[30,0.71,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[5,0,0,0,0],"numValues":[38,11.9,0,0,0,0]}]} */
