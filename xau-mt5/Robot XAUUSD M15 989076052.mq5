...
static input int    Magic_Number = 989076052; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =     2083; // Stop Loss   (pips)
       input int    Take_Profit  =     3645; // Take Profit (pips)

static input string ___0______   = "------"; // --- Williams' Percent Range ---
       input int    Ind0Param0   =       25; // Period
       input double Ind0Param1   =    -31.0; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":2083,"takeProfit":3645,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[25,-31,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[0,3,0,0,0],"numValues":[3,0,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[3,3,0,0,0],"numValues":[16,3.07,0,0,0,0]}]} */
