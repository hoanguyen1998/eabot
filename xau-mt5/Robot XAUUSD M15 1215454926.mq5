...
static input int    Magic_Number = 1215454926; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =     2808; // Stop Loss   (pips)
       input int    Take_Profit  =     3781; // Take Profit (pips)

static input string ___0______   = "------"; // --- MACD Signal ---
       input int    Ind0Param0   =       20; // Fast EMA
       input int    Ind0Param1   =       27; // Slow EMA
       input int    Ind0Param2   =        3; // MACD SMA
...
void InitIndicators(void)
  {
   ...
   // Commodity Channel Index (Typical, 42), Level: 100
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":2808,"takeProfit":3781,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"MACD Signal","listIndexes":[1,3,0,0,0],"numValues":[20,27,3,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[2,5,0,0,0],"numValues":[42,100,0,0,0,0]}],"closeFilters":[{"name":"Awesome Oscillator","listIndexes":[4,0,0,0,0],"numValues":[0,0,0,0,0,0]}]} */
