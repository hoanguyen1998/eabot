...
static input int    Magic_Number = 936188241; // Magic number
static input double Entry_Amount =     0.01; // Entry lots
       input int    Stop_Loss    =     3286; // Stop Loss   (pips)
       input int    Take_Profit  =     4980; // Take Profit (pips)

static input string ___0______   = "------"; // --- Williams' Percent Range ---
       input int    Ind0Param0   =       43; // Period
       input double Ind0Param1   =    -11.0; // Level

static input string ___1______   = "------"; // --- Bulls Power ---
       input int    Ind1Param0   =       38; // Period
       input double Ind1Param1   = -30.7000; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":3286,"takeProfit":4980,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":true},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[4,0,0,0,0],"numValues":[43,-11,0,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[3,0,0,0,0],"numValues":[38,-30.7,0,0,0,0]}]} */
