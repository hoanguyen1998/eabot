...
static input int    Magic_Number = 49056063; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":30,"takeProfit":60,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[2,5,10,0,0,0]}],"closeFilters":[{"name":"Do not Exit","listIndexes":[0,0,0,0,0],"numValues":[0,0,0,0,0,0]}]} */
