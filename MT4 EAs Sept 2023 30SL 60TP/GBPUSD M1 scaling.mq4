...
input int Slot0IndParam0 = 8; // Period
...
input int Slot1IndParam1 = 45; // Level
static input string IndicatorName2 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 6; // Fast MA period
input int Slot2IndParam1 = 22; // Slow MA period
...
input int Slot5IndParam0 = 300; // Stop Loss
...
static input int Expert_Magic = 16141653; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.FirstBar               = 13;
   strategy.MinBarsRequired        = 32;
