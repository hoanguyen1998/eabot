//+--------------------------------------------------------------------+
//| Copyright:  (C) 2022 Forex Software Ltd.                           |
...
#property copyright "Copyright (C) 2022 Forex Software Ltd."
...
input int Slot0IndParam2 = 18; // Kijun
input int Slot0IndParam4 = 51; // Senkou Span B
...
input int Slot3IndParam0 = 35; // Period of %R
input int Slot3IndParam1 = 20; // Smoothing period
...
input int Slot4IndParam1 = 600; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 25141929; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.Description            = "Exported on 1/25/2023 from Forex Strategy Builder Professional, v4.0";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 54;
   strategy.MinBarsRequired        = 57;
