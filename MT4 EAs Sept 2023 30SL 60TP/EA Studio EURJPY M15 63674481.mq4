...
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":30,"takeProfit":60,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[4,3,0,0,0],"numValues":[6,2.05,0,0,0,0]},{"name":"Force Index","listIndexes":[2,0,0,0,0],"numValues":[20,0,0,0,0,0]}],"closeFilters":[{"name":"Do not Exit","listIndexes":[0,0,0,0,0],"numValues":[0,0,0,0,0,0]}]} */
