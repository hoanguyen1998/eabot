...
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =       96; // Stop Loss   (pips)
       input int    Take_Profit  =       47; // Take Profit (pips)
...
static input string ___1______   = "------"; // --- Envelopes ---
       ...
       input double Ind1Param1   =     0.27; // Deviation %

static input string ___2______   = "------"; // --- RSI ---
       input int    Ind2Param0   =       29; // Period
       input int    Ind2Param1   =       16; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 38229059; // Magic Number
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; USDJPY; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":96,"takeProfit":47,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Awesome Oscillator","listIndexes":[4,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Envelopes","listIndexes":[3,3,0,0,0],"numValues":[29,0.27,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[29,16,0,0,0,0]}]} */
