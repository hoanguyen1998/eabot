...
static input int    Magic_Number = 1715660203; // Magic number
...
static input string ___0______   = "------"; // --- MACD Signal ---
       ...
       input int    Ind0Param2   =        6; // MACD SMA

static input string ___1______   = "------"; // --- Stochastic ---
       input int    Ind1Param0   =        5; // %K Period
       input int    Ind1Param1   =        2; // %D Period
       input int    Ind1Param2   =        3; // Slowing
...
static input string ___4______   = "------"; // --- Candle Color ---
       input int    Ind4Param0   =       38; // Min body height [pips]
       input int    Ind4Param1   =        1; // Consecutive candles
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":95,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"MACD Signal","listIndexes":[0,3,0,0,0],"numValues":[20,50,6,0,0,0]},{"name":"Stochastic","listIndexes":[1,0,0,0,0],"numValues":[5,2,3,50,0,0]},{"name":"Directional Indicators","listIndexes":[2,0,0,0,0],"numValues":[42,0,0,0,0,0]},{"name":"Bulls Power","listIndexes":[2,0,0,0,0],"numValues":[48,0,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[38,1,0,0,0,0]}]} */
