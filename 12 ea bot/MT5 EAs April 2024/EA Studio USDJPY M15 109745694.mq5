...
static input int    Magic_Number = 109745694; // Magic number
...
static input string ___1______   = "------"; // --- Bulls Power ---
       input int    Ind1Param0   =       50; // Period
       input double Ind1Param1   =   0.6800; // Level

static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       22; // Min body height [pips]
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":50,"takeProfit":73,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[50,0.68,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[22,4,0,0,0,0]}]} */
