...
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =       72; // Stop Loss   (pips)
...
static input string ___1______   = "------"; // --- Stochastic ---
       ...
       input int    Ind1Param1   =        1; // %D Period
       input int    Ind1Param2   =       10; // Slowing
       input double Ind1Param3   =      8.0; // Level

static input string ___2______   = "------"; // --- Momentum ---
       input int    Ind2Param0   =       35; // Period
       input double Ind2Param1   = 101.0000; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 38081899; // Magic Number
...
int GetEntrySignal(void)
  {
   ...
   bool   ind1short = ind1val1 > 100 - Ind1Param3 + sigma && ind1val2 < 100 - Ind1Param3 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":72,"takeProfit":90,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Commodity Channel Index","listIndexes":[0,5,0,0,0],"numValues":[8,0,0,0,0,0]},{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[16,1,10,8,0,0]}],"closeFilters":[{"name":"Momentum","listIndexes":[4,3,0,0,0],"numValues":[35,101,0,0,0,0]}]} */
