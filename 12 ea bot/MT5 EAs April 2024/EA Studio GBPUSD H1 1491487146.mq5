...
static input int    Magic_Number = 1491487146; // Magic number
...
static input string ___1______   = "------"; // --- Candle Color ---
       input int    Ind1Param0   =       11; // Min body height [pips]
...
int GetEntrySignal(void)
  {
   ...
   bool ind1short = false;
   {
      ...
      ind1long  = consecutiveBearish >= Ind1Param1;
      ind1short = consecutiveBullish >= Ind1Param1;
   }
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":40,"takeProfit":79,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[11,4,0,0,0,0]}],"closeFilters":[{"name":"Momentum","listIndexes":[5,3,0,0,0],"numValues":[3,97,0,0,0,0]}]} */
