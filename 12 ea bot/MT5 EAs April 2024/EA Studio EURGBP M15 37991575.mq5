...
static input string ___0______   = "------"; // --- Stochastic ---
       ...
       input int    Ind0Param2   =       15; // Slowing
       input double Ind0Param3   =     27.0; // Level

static input string ___1______   = "------"; // --- Envelopes ---
       input int    Ind1Param0   =       29; // Period
       input double Ind1Param1   =     0.64; // Deviation %
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 37991575; // Magic Number
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET MetaTrader-Demo; EURGBP; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":82,"takeProfit":79,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[4,0,0,0,0],"numValues":[19,13,15,27,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[29,0.64,0,0,0,0]}]} */
