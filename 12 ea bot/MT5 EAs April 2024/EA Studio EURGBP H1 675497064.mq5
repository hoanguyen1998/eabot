...
static input int    Magic_Number = 675497064; // Magic number
static input double Entry_Amount =     0.10; // Entry lots
       input int    Stop_Loss    =       87; // Stop Loss   (pips)
...
static input string ___2______   = "------"; // --- Momentum ---
       ...
       input double Ind2Param1   =  56.6268; // Level
...
void InitIndicators(void)
  {
   // Commodity Channel Index (Typical, 29), Level: 0
   ...
   // Momentum (Close, 12), Level: 56.6268
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":87,"takeProfit":75,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Commodity Channel Index","listIndexes":[4,5,0,0,0],"numValues":[29,0,0,0,0,0]},{"name":"ADX","listIndexes":[7,0,0,0,0],"numValues":[11,0,0,0,0,0]}],"closeFilters":[{"name":"Momentum","listIndexes":[4,3,0,0,0],"numValues":[12,56.6268,0,0,0,0]}]} */
