...
static input double Entry_Amount =     0.10; // Entry lots
       ...
       input int    Take_Profit  =       96; // Take Profit (pips)

static input string ___0______   = "------"; // --- Alligator ---
       input int    Ind0Param0   =       30; // Jaws period
       input int    Ind0Param1   =       14; // Jaws shift
       input int    Ind0Param2   =       14; // Teeth period
       input int    Ind0Param3   =       12; // Teeth shift
       input int    Ind0Param4   =       12; // Lips period
       input int    Ind0Param5   =        5; // Lips shift

static input string ___1______   = "------"; // --- Commodity Channel Index ---
       input int    Ind1Param0   =       28; // Period
       input int    Ind1Param1   =       19; // Level

static input string ___2______   = "------"; // --- Bollinger Bands ---
       input int    Ind2Param0   =       27; // Period
       input double Ind2Param1   =     3.18; // Deviation

static input string ___3______   = "------"; // --- DeMarker ---
       input int    Ind3Param0   =       22; // Period
       input double Ind3Param1   =     0.29; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 38131072; // Magic Number
...
void InitIndicators(void)
  {
   // Alligator (Smoothed, Median, 30, 14, 14, 12, 12, 5)
   ...
   // Commodity Channel Index (Typical, 28), Level: 19
   indHandlers[0][1][0] = iCCI(NULL, 0, Ind1Param0, PRICE_TYPICAL);
   ChartIndicatorAdd(0, 1, indHandlers[0][1][0]);
   // Bollinger Bands (Close, 27, 3.18)
   indHandlers[0][2][0] = iBands(NULL, 0, Ind2Param0, 0, Ind2Param1, PRICE_CLOSE);
   ChartIndicatorAdd(0, 0, indHandlers[0][2][0]);
   // DeMarker (22), Level: 0.29
   indHandlers[0][3][0] = iDeMarker(NULL, 0, Ind3Param0);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":65,"takeProfit":96,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Alligator","listIndexes":[11,3,4,0,0],"numValues":[30,14,14,12,12,5]},{"name":"Commodity Channel Index","listIndexes":[2,5,0,0,0],"numValues":[28,19,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[2,3,0,0,0],"numValues":[27,3.18,0,0,0,0]},{"name":"DeMarker","listIndexes":[5,0,0,0,0],"numValues":[22,0.29,0,0,0,0]}]} */
