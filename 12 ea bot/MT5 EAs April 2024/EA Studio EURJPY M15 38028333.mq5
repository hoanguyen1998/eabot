...
static input string ___2______   = "------"; // --- Standard Deviation ---
       ...
       input double Ind2Param1   =   2.0000; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 38028333; // Magic Number
...
void InitIndicators(void)
  {
   ...
   // Standard Deviation (Close, Simple, 3), Level: 2.0000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":86,"takeProfit":99,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[5,0,0,0,0],"numValues":[22,0,0,0,0,0]},{"name":"Bears Power","listIndexes":[0,0,0,0,0],"numValues":[20,0,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[4,3,0,0,0],"numValues":[3,2,0,0,0,0]}]} */
